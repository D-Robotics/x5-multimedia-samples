...
void resize_performance_test(struct PerformanceTestParam *param, float rate)
{
	...
	char performance_test_name[128];
	memset(performance_test_name, 0, sizeof(performance_test_name));
	sprintf(performance_test_name, "(%d*%d) resize to (%d*%d)",
	...
	performance_test_stop_with_name(param, performance_test_name);
