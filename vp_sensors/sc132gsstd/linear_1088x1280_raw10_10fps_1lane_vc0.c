...
static camera_config_t camera_config = {
	...
	.gpio_level_bit = 0x00,
	.calib_lname = "disable",
	.extra_mode = 0,  // use this attribute to transfer virtual channel index
};

static vin_node_attr_t vin_node_attr = {
	.cim_attr = {
		.mipi_rx = 0,
		.vc_index = 0,  // Virtual channel index0, bind to serial tx0
		.ipi_channel = 1,
...
vp_sensor_config_t sc132gsstd_linear_1088x1280_raw10_10fps_1lane_vc0 = {
	.chip_id_reg = 0x3107,
	.chip_id = 0x0132,
	.sensor_i2c_addr_list = {0x30, 0x33},
	.sensor_name = "sc132gsstd_vc0",
	.sensor_type = SENSOR_TYPE_HSMT_RAW,
	.config_file = "linear_1088x1280_raw10_10fps_1lane_vc0.c",
