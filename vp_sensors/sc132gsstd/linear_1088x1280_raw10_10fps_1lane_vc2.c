...
static mipi_config_t mipi_config = {
	...
	.rx_attr = {
		.phy = 0,
		.lane = 4,  // Desrializer 4lane (The deserializer is connected to the soc mipi, so configure it according to the status of this device)
		.datatype = RAW10,
		.fps = SENSOR_FPS,
		.mclk = 1,
		.mipiclk = 4000,  // 2lane 2400,  // 4lane 4000  // 1 lane 1200
		.width = SENSOR_WIDTH,
...
static camera_config_t camera_config = {
	...
	.gpio_level_bit = 0x00,
	.calib_lname = "disable",
	.extra_mode = 2,  // use this attribute to transfer virtual channel index
};

static vin_node_attr_t vin_node_attr = {
	.cim_attr = {
		.mipi_rx = 0,
		.vc_index = 2,  // Virtual channel index2, bind to serial tx2
		.ipi_channel = 1,
		.cim_isp_flyby = 0,   // 1 mcm\online, 0: offline
		.func = {
			.enable_frame_id = 1,
			.set_init_frame_id = 0,
			.hdr_mode = NOT_HDR,
...
vp_sensor_config_t sc132gsstd_linear_1088x1280_raw10_10fps_1lane_vc2 = {
	.chip_id_reg = 0x3107,
	.chip_id = 0x0132,
	.sensor_i2c_addr_list = {0x30, 0x33},
	.sensor_name = "sc132gsstd_vc2",
	.sensor_type = SENSOR_TYPE_HSMT_RAW,
	.config_file = "linear_1088x1280_raw10_10fps_1lane_vc2.c",
